...
class FinalLeadEntryPage extends StatefulWidget {
  final String leadsId;
  const FinalLeadEntryPage({super.key, required this.leadsId});
  @override
  FinalLeadEntryPageState createState() => FinalLeadEntryPageState();
}

class LeadProductsFinalStageProvider with ChangeNotifier {
...
class FinalLeadEntryPageState extends State<FinalLeadEntryPage> {
  final _formKey = GlobalKey<FormState>();
  final _quotationnumberController = TextEditingController();
  final _customernameController = TextEditingController();
  final _remarksController = TextEditingController();
  String selectedStatusValue = 'Open';
      ...
      if (response.statusCode == 200) {
        ...
        if (responseJson['Status'] == true &&
          ...
          if (data[0] is List) {
            ...
            setState(() {
              context
                  .read<LeadProductsFinalStageProvider>()
                  .updateLeadQuotation(newLeadQuotation);
              quotationList = convertLeadQuotationToMapList(newLeadQuotation);
              if (data[0].length > 0) {
                _customernameController.text = data[0][0]['LeadCustomerName']
                    .toString();
              } else {
  ...
  List<Map<String, Object>> convertLeadQuotationToMapList(
    ...
    return leadQuotation
        ...
        .map((leadQuotation) {
          ...
          bool leadEditable = leadQuotation.leadStage7EntryId.toString() != '0'
              ? true
              : false;
          return {
            ...
            "leadStage7Id": leadQuotation.leadStage7Id,
            "leadStage7EntryId": leadQuotation.leadStage7EntryId,
            "leadStage7Status": leadQuotation.leadStage7Status,
            "leadStage7Remarks": leadQuotation.leadStage7Remarks,
            "leadCustomerName": leadQuotation.leadCustomerName,
          };
        })
        .toList();
  }
  ...
  void loadQuotationDetailsForEdit(
    ...
    int leadStage7EntryId = item['leadStage7EntryId'] as int;
    selectedQuotationList = quotationList
        .where(
          (quotationItem) =>
              quotationItem['leadStage7EntryId'] == leadStage7EntryId,
        )
        .toList();
    ...
    for (Map<String, Object> quotationItem in quotationList) {
      ...
      selectedQuotationIds.add(quotationItem['leadStage7Id'] as int);
      _remarksController.text = quotationItem['leadStage7Remarks'] as String;
      _customernameController.text =
          quotationItem['leadCustomerName'] as String;
      setState(() {
        selectedStatusValue = quotationItem['leadStage7Status'] as String;
      });
    }
  ...
  Future<void> submitFinalStage() async {
    ...
    final leadfinalstage = {
      ...
      'LeadStage7Remarks': _remarksController.text,
                          ...
                          child: ListTile(
                            ...
                            title: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'PO Released On: ${item['leadStage6PoDate']}',
                                ),
                              ],
                            ),
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: DropdownButton<String>(
                      ...
                      items: <String>['Open', 'Won', 'Lost'].map((
                        String value,
                      ) {
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    decoration: const InputDecoration(
                      border: UnderlineInputBorder(),
                      labelText: 'Customer Name', // Change the label text
                      hintText: 'Customer Name', // Change the hint text
                      hintStyle: TextStyle(fontSize: 14, fontFamily: 'Poppins'),
                    ),
                  ),
                ),
              ...
              SizedBox(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    height: 50,
                    decoration: BoxDecoration(
                      color: const Color.fromARGB(255, 223, 44, 44),
