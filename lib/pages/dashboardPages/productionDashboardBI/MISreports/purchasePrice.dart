...
ItemSubGroupBarDataList itemSubGroupBarData = ItemSubGroupBarDataList(list: []);
...
// ItemSubGroupBarList itemSubGroupList =
// ItemSubGroupBarList(items: []);
...
class _PurchasePriceMISState extends State<PurchasePriceMIS> {
  ...
  List<BarChartGroupData> _itemGroupWiseChartData(List<MonthlySalesData> data) {
    return data
        .map(
  ...
  Future<void> _loadPurchasePrice(String UserName, String UserLevel) async {
    ...
    try {
      ...
      setState(() {
        ...
        context.read<PurchasePriceMISProvider>().updatePurchaseList(salesList);
  ...
  Future<void> loadDataWithBranchFilter(String branch) async {
    ...
    // stockData =
    //     stockData.where((test) => test.warehouseName == branch).toList();
      ...
      child: SizedBox(
        ...
        child: BarChart(
          BarChartData(
            ...
            barGroups: _inventoryAgeingChartData(itemSubGroupBarData.list),
                ...
                getTooltipItem: (groupData, grpIndex, rodData, rodIndex) {
                  return BarTooltipItem(
                    ...
                    children: <TextSpan>[
                      TextSpan(
                        text:
                            "\nSum of Purchase Qty : ${formatAmount(itemSubGroupBarData.list[grpIndex].sumQuantity)}",
                      ...
                      TextSpan(
                        text:
                            "\nAverage Price : ${formatAmount(itemSubGroupBarData.list[grpIndex].averagePrice)}",
                        style: const TextStyle(
                          color: Colors.black, //widget.touchedBarColor,
                          fontSize: 12,
                          fontWeight: FontWeight.w500,
                      ...
                      TextSpan(
                        text:
                            "\nSum of Purchase Amount : ${formatAmount(itemSubGroupBarData.list[grpIndex].sumRowTotal)}",
                        style: const TextStyle(
                          color: Colors.black, //widget.touchedBarColor,
                          fontSize: 12,
                          fontWeight: FontWeight.w500,
      ...
      child: SizedBox(
        ...
        child: BarChart(
          BarChartData(
            ...
            barGroups: _itemGroupWiseChartData(monthlySalesData.list),
            barTouchData: BarTouchData(
              allowTouchBarBackDraw: true,
              touchCallback: (flTouchEvent, barTouchResponse) async {
                if (barTouchResponse != null && barTouchResponse.spot != null) {
                ...
                getTooltipItem: (groupData, grpIndex, rodData, rodIndex) {
                  return BarTooltipItem(
                    ...
                    children: <TextSpan>[
                      TextSpan(
                        text:
                            "Sum of Purchase Amount: ${formatAmount(monthlySalesData.list[grpIndex].sumRowTotal)}",
                        style: const TextStyle(
                          color: Colors.black, //widget.touchedBarColor,
                          fontSize: 12,
                          fontWeight: FontWeight.w500,
                      ...
                      TextSpan(
                        text:
                            "Average Price: ${formatAmount(monthlySalesData.list[grpIndex].sumRowTotal / monthlySalesData.list[grpIndex].sumQuantity)}",
                        style: const TextStyle(
                          color: Colors.black, //widget.touchedBarColor,
                          fontSize: 12,
                          fontWeight: FontWeight.w500,
                      ...
                      TextSpan(
                        text:
                            "Sum of Purchase Quantity: ${formatAmount(monthlySalesData.list[grpIndex].sumQuantity / monthlySalesData.list[grpIndex].sumQuantity)}",
                        style: const TextStyle(
                          color: Colors.black, //widget.touchedBarColor,
                          fontSize: 12,
                          fontWeight: FontWeight.w500,
