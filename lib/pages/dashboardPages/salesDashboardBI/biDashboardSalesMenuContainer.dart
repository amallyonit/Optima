...
import 'package:optima/pages/dashboardPages/salesDashboardBI/opportunityAnalysisBI.dart';
...
class SalesBI extends StatefulWidget {
  const SalesBI({super.key});

  @override
  State<SalesBI> createState() => _SalesBIState();
}

String menuPermissionMenuIds = "";

class _SalesBIState extends State<SalesBI> {
  List<String> items = [
    "",
    "Sales \nAnalysis",
    "SO \nAnalysis",
  ...
  List<Widget> pages = [
    ...
    const VisitAnalysisPage(),
    const OpportunityAnalysisPage(),
  ];

  List<int> menuIds = []; // To store the parsed menuPermissionMenuIds
  int current = 0;
  ...
  void _filterPagesByPermission() {
    if (menuPermissionMenuIds == "All") {
      ...
      menuIds = [1, 2, 3, 4, 5, 30]; // Add all available menu IDs here
    ...
    final Map<int, dynamic> menuToPageMap = {
      1: {"title": "Sales \nAnalysis", "page": const SalesPerformancePage()},
      2: {"title": "SO \nAnalysis", "page": const SOAnalysisPage()},
      3: {
        "title": "Collection \nAnalysis",
        "page": const CollectionAnalysisPage(),
      },
      4: {"title": "Visit \nAnalysis", "page": const VisitAnalysisPage()},
      5: {
        "title": "Opportunity \nAnalysis",
        "page": const OpportunityAnalysisPage(),
      },
      30: {
        "title": "Delivery \nAnalysis",
        "page": const ComingSoonPage(), //const DeliveryAnalysisPage(),
      },
    };
