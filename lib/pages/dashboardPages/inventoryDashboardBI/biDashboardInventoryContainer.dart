...
import 'package:optima/pages/dashboardPages/inventoryDashboardBI/inventoryAnalysis.dart';
...
class InventoryBI extends StatefulWidget {
  const InventoryBI({super.key});

  @override
  State<InventoryBI> createState() => _InventoryBIState();
}

String menuPermissionMenuIds = "";

class _InventoryBIState extends State<InventoryBI> {
  List<String> items = [
    "",
    "Inventory\nAnalysis",
    "Inventory\nMovement Analysis",
  ...
  List<Widget> pages = [
    ...
    const InventoryMovementAnalysis(),
    const InventoryAgeingAnalysis(),
    const InventorySlowDeadAnalysis(),
  ];
  ...
  void _filterPagesByPermission() {
    if (menuPermissionMenuIds == "All") {
      ...
      menuIds = [26, 27, 28, 29]; // Add all available menu IDs here
    ...
    final Map<int, dynamic> menuToPageMap = {
      26: {"title": "Inventory\nAnalysis", "page": const InventoryAnalysis()},
      27: {
        "title": "Inventory\nMovement Analysis",
        "page": const InventoryMovementAnalysis(),
      },
      28: {
        "title": "Inventory\nAgeing Analysis",
        "page": const InventoryAgeingAnalysis(),
      },
      29: {
        "title": "Inventory Slow\nDead Analysis",
        "page": const InventorySlowDeadAnalysis(),
      },
    };
